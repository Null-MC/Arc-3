    ...
    return new Page('main')
        ...
        .add(new Page('POST')
            .add(new Page('POST_EXPOSURE')
                .add(asFloatRange('POST_EXPOSURE_MIN',   -1.2, -6.0,  0.0, 0.2, false))
                .add(asFloatRange('POST_EXPOSURE_MAX',   16.6,  0.0, 20.0, 0.2, false))
                .add(asFloatRange('POST_EXPOSURE_RANGE', 16.0,  3.0, 19.0, 0.2, false))
                .build())
            .add(new Page('POST_BLOOM')
                .add(asBool('POST_BLOOM_ENABLED', true, true))
                .add(asFloatRange('POST_BLOOM_STRENGTH', 2.0, 0.2, 20.0, 0.1, false))
                .build())
            .add(new Page('POST_TAA')
                .add(asBool('POST_TAA_ENABLED', true, true))
                .add(EMPTY)
                .add(asBool('POST_TAA_CUBIC_HISTORY', true, true))
                .add(asIntRange('POST_TAA_CAS_STRENGTH', 60, 0, 100, 2, false))
                .build())
            .build())
        .add(EMPTY)
        .add(new Page('DEBUG')
