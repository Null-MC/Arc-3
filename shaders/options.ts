    ...
    return new Page('main')
        ...
        .add(new Page('LIGHTING')
            .add(new Page('LIGHTING_REFRACTION')
                .add(asInt('LIGHTING_REFRACT_MODE', 0, 1, 2).needsReload(true).build(2))
                .add(asBool('LIGHTING_REFRACT_SS_FALLBACK', true, true))
                .add(asBool('LIGHTING_REFRACT_ROUGH', true, true))
                .build())
            .add(new Page('LIGHTING_REFLECTIONS')
                .add(asInt('LIGHTING_REFLECT_MODE', 0, 1, 2, 3).needsReload(true).build(3))
                .add(asBool('LIGHTING_REFLECT_SS_FALLBACK', true, true))
                .add(asBool('LIGHTING_REFLECT_ROUGH', true, true))
                .build())
