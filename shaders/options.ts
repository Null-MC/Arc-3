export function setupOptions() {
    return new Page('main')
        .add(new Page('SKY')
            ...
            .add(EMPTY)
            .add(asIntRange('SKY.DUST_DENSITY', 100, 0, 800, 5, false))
            .build())
        .add(new Page('WATER')
            .add(asBool('WATER.WAVES_ENABLED', true, true))
            .add(asIntRange('WATER.WAVE_SIZE', 20, 2, 100, 2, false))
            .add(asIntRange('WATER.DIRT_LEVEL', 24, 0, 100, 2, false))
            .build())
        .add(new Page('MATERIAL')
            .add(asInt('MATERIAL.FORMAT', 0, 1, 2).needsReload(true).build(0))
            .add(asIntRange('MATERIAL.MIP_BIAS', 0, 0, 200, 5, false))
            .add(EMPTY)
            ...
            .add(new Page("MATERIAL.PARALLAX")
                ...
                .build())
            .add(new Page("MATERIAL.POROSITY")
                .add(asInt('MATERIAL.POROSITY.FORMAT', -1, 0, 1, 2).needsReload(true).build(0))
                .build())
            .add(new Page("MATERIAL.EMISSION")
                .add(asInt('MATERIAL.EMISSION.FORMAT', -1, 0, 1, 2).needsReload(true).build(0))
                .add(EMPTY)
                .add(asIntRange('MATERIAL.EMISSION.SCALE', 100, 5, 400, 5, false))
                .add(asIntRange('MATERIAL.EMISSION.CURVE', 200, 5, 400, 5, false))
                .build())
            .build())
        ...
        .add(new Page('POST')
            .add(new Page('POST.TONEMAP')
                .add(asIntRange('POST.TONEMAP.SATURATION', 96, 2, 160, 2, false))
                // .add(asIntRange('POST.TONEMAP.CONTRAST', 80, 10, 190, 2, false))
                .add(EMPTY)
                .add(asIntRange('POST.TONEMAP.RED_OFFSET',   0, -100, 100, 1, false))
                .add(asIntRange('POST.TONEMAP.RED_SCALE',  100,    2, 200, 1, false))
                .add(asIntRange('POST.TONEMAP.RED_POWER',  108,    2, 200, 1, false))
                .add(EMPTY)
                .add(asIntRange('POST.TONEMAP.GREEN_OFFSET',   0, -100, 100, 1, false))
                .add(asIntRange('POST.TONEMAP.GREEN_SCALE',  100,    2, 200, 1, false))
                .add(asIntRange('POST.TONEMAP.GREEN_POWER',  106,    2, 200, 1, false))
                .add(EMPTY)
                .add(asIntRange('POST.TONEMAP.BLUE_OFFSET',   0, -100, 100, 1, false))
                .add(asIntRange('POST.TONEMAP.BLUE_SCALE',  100,    2, 200, 1, false))
                .add(asIntRange('POST.TONEMAP.BLUE_POWER',  104,    2, 200, 1, false))
                .build())
            .add(new Page('POST.EXPOSURE')
                ...
                .build())
            .add(new Page('POST.VIGNETTE')
                .add(asBool('POST.VIGNETTE.ENABLED', true, true))
                .add(asIntRange('POST.VIGNETTE.SCALE', 40, 2, 100, 2, false))
                .build())
