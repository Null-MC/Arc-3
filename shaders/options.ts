    ...
    return new Page('main')
        ...
        .add(new Page('POST')
            .add(new Page('POST.TONEMAP')
                .add(asIntRange('POST.TONEMAP.CONTRAST', 70, 10, 190, 2, false))
                .build())
            .add(new Page('POST.EXPOSURE')
                .add(asFloatRange('POST.EXPOSURE.MIN',   -1.2, -6.0,  0.0, 0.2, false))
                .add(asFloatRange('POST.EXPOSURE.MAX',   16.6,  0.0, 20.0, 0.2, false))
                .add(asFloatRange('POST.EXPOSURE.RANGE', 9.6,  3.0, 19.0, 0.2, false))
                .build())
            ...
            .add(new Page('POST.TAA')
                ...
                .add(EMPTY)
                .add(asBool('POST.TAA.CUBIC_HISTORY', true, true))
