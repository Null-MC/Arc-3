export function setupOptions() {
    return new Page('main')
        .add(new Page('SKY')
            ...
            .add(asIntRange('SKY.FOG_DENSITY', 100, 0, 300, 5, true))
            .add(asBool('SKY.FOG_NOISE', false, true))
            .build())
        .add(new Page('WATER')
            .add(asBool('WATER.WAVES_ENABLED', true, true))
            .add(asIntRange('WATER.WAVE_SIZE', 60, 2, 100, 2, false))
            .build())
        .add(new Page('MATERIAL')
            ...
            .add(new Page("MATERIAL.PARALLAX")
                .add(asBool('MATERIAL.PARALLAX_ENABLED', false, true))
                .add(EMPTY)
                .add(asInt('MATERIAL.PARALLAX_TYPE', 0, 1, 2).needsReload(true).build(1))
                .add(asIntRange('MATERIAL.PARALLAX_DEPTH', 25, 5, 100, 5, false))
                .add(asIntRange('MATERIAL.PARALLAX_SAMPLES', 32, 8, 128, 8, true))
                .add(asBool('MATERIAL.PARALLAX_OPTIMIZE', true, true))
                .build())
            .build())
