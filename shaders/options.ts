    ...
    return new Page('main')
        ...
        .add(new Page('POST')
            .add(new Page('POST.TONEMAP')
                ...
                .add(EMPTY)
                .add(asIntRange('POST.TONEMAP.RED_OFFSET',   0, -100, 100, 2, false))
                .add(asIntRange('POST.TONEMAP.RED_SCALE',  100,    2, 200, 2, false))
                .add(asIntRange('POST.TONEMAP.RED_POWER',  100,    2, 200, 2, false))
                .add(EMPTY)
                .add(asIntRange('POST.TONEMAP.GREEN_OFFSET',   0, -100, 100, 2, false))
                .add(asIntRange('POST.TONEMAP.GREEN_SCALE',  100,    2, 200, 2, false))
                .add(asIntRange('POST.TONEMAP.GREEN_POWER',  100,    2, 200, 2, false))
                .add(EMPTY)
                .add(asIntRange('POST.TONEMAP.BLUE_OFFSET',   0, -100, 100, 2, false))
                .add(asIntRange('POST.TONEMAP.BLUE_SCALE',  100,    2, 200, 2, false))
                .add(asIntRange('POST.TONEMAP.BLUE_POWER',  100,    2, 200, 2, false))
                .build())
